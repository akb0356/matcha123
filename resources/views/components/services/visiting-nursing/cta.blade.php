{{-- Figma 153:1915 (Frame 111) — 최종 CTA --}}
<section class="flex w-full flex-col items-center justify-center gap-14 bg-caution px-6 py-[100px]">
    <h2 class="w-full text-center text-eb44 text-surface lg:text-eb72">
        집에서 받는 전문 간호, <br class="hidden lg:inline">지금 무료로 상담해 보세요
    </h2>
    ...
    <div class="flex w-full max-w-[422px] flex-col items-stretch gap-3 sm:flex-row sm:items-center">
        <a href="#"
           class="btn-hover flex h-[68px] flex-1 items-center justify-center gap-2 rounded-md bg-surface px-7 text-b16 text-caution">
            서비스 신청하기
            <img src="{{ asset('images/icons/arrow-right.svg') }}" alt="" class="h-5 w-5">
        </a>
        <a href="#"
