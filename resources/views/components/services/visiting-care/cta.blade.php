...
<section class="flex w-full flex-col items-center justify-center gap-24 bg-accent-violet px-6 py-[100px]">
    ...
    <div class="flex w-full max-w-[422px] items-center gap-3">
        <a href="#"
           class="flex h-[68px] flex-1 items-center justify-center gap-2 rounded-md bg-[#fefeff] px-7 text-b16 text-accent-violet">
            서비스 신청하기
            <img src="{{ asset('images/icons/arrow-right-violet.svg') }}" alt="" class="h-5 w-5">
        </a>
        <a href="#"
