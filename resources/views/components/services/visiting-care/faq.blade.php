...
@php
     ...
     * 5번은 방문간호와 문항이 완전히 같고 답변도 서비스와 무관한 내용이라 그대로 가져왔다.
     * 2~4번은 방문요양 전용 문안이 필요해 null로 두었다(임의 작성하지 않는다).
    ...
    $faqs = [
        ...
        ['question' => '담당 요양보호사 한 분이 계속 방문하나요?', 'answer' => null, 'open' => false],
        ['question' => '요양보호사를 변경할 수 있나요?', 'answer' => null, 'open' => false],
        ['question' => '어떤 일까지 도와주시나요?', 'answer' => null, 'open' => false],
        [
